...
public partial class Rex640AccessoryCatalogWindow : Window
{
    private const string AllCategoryFilter = "全部分类 / All categories";
    private readonly Rex640AccessoryCatalogService _catalogService = new();
    private readonly ObservableCollection<Rex640AccessoryCatalogItem> _rows = [];

    public Rex640AccessoryCatalogWindow()
    {
        InitializeComponent();
    ...
    private void CopyProductButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        {
            ClipboardService.TrySetText(product, "REX640");
        }
    }
